...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package telephone-line
    ...
    (progn
      ...
      ;; (setq telephone-line-evil-emacs ((t (:inherit telephone-line-evil))))
      ;; (setq telephone-line-evil-insert ((t (:inherit telephone-line-evil :background "dark red"))))
      ;; (setq telephone-line-evil-normal ((t (:inherit telephone-line-evil :background "forest green"))))
      )
    )
#+END_SRC
* Icons
